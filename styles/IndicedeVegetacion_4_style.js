...
var style_IndicedeVegetacion_4 = function(feature, resolution){
    ...
    if (value >= 0.280600 && value <= 0.413161) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.413161 && value <= 0.545721) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.545721 && value <= 0.678282) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.678282 && value <= 0.810843) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.810843 && value <= 0.943403) {
            style = [ new ol.style.Style({
