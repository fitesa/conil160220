...
var style_EvolucionIndicedeVegetacion_3 = function(feature, resolution){
    ...
    if (value >= -0.017936 && value <= 0.075941) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.075941 && value <= 0.169819) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.169819 && value <= 0.263696) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.263696 && value <= 0.357573) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.357573 && value <= 0.451450) {
            style = [ new ol.style.Style({
