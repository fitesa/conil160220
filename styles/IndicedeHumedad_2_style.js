...
var style_IndicedeHumedad_2 = function(feature, resolution){
    ...
    if (value >= -0.073179 && value <= 0.046199) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.046199 && value <= 0.165576) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.165576 && value <= 0.284954) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.284954 && value <= 0.404332) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.404332 && value <= 0.523710) {
            style = [ new ol.style.Style({
